...
import { WeekDays } from '../common/models/calendar.model';
...
export class DayCalendarService {
    ...
    getMonthCalendarConfig(componentConfig: IDayCalendarConfigInternal): IMonthCalendarConfig {
        return this.utilsService.clearUndefined({
            ...
            showSwitchLocale: componentConfig.showSwitchLocale,
            showTimeView: componentConfig.showTimeView
        });
    }
    ...
    getDayBtnText(config: IDayCalendarConfigInternal, day: Moment): string {
        ...
        let num = config.locale === 'fa' ? this.utilsService.toPersian(day.format(config.dayBtnFormat)) : day.format(config.dayBtnFormat);
        return num;
    }
